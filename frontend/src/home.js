        ...
        <section className="max-w-[1400px] w-11/12 mx-auto sl-pt-10">
          <div className="flex flex-wrap p-4">
            <div className="xl:w-3/5 lg:w-1/2 w-full lg:sl-py-20 md:sl-py-8 sl-py-4  lg:sl-order-1- sl-order-2-">
              ...
              <button className="inline-flex sl-mr-2 items-center uppercase md:text-base text-sm font-medium sl-px-4 sl-py-2 bg-teal-400 rounded-sm hover:bg-teal-700 sl-animated-lg" onClick={e => window.location.href = `${config.baseUrl}signup`}>sing up for free <img className="w-4 sl-ml-2" src={rightArrow} alt="" /></button>
              <button className="inline-flex items-center uppercase md:text-base text-sm font-medium sl-px-4 sl-py-2 bg-neutral-800 rounded-sm hover:bg-neutral-950 sl-animated-lg" onClick={e => window.location.href = `${config.baseUrl}Exchange`} >market <img className="w-4 sl-ml-2" src={rightArrow} alt="" /></button>
            </div>
            ...
            <Swiper
              ...
              }}>
              {
                this.state.sliderImages && this.state.sliderImages.map(img => (
                  <SwiperSlide>
                    <a href=""><img src={img.imageUrl} className="w-full rounded slider-image" alt="" /></a>
                  </SwiperSlide>
                ))
              }
          ...
          <div className="flex flex-wrap justify-center">
                      ...
                      <a href={lis.link} target="_blank" key={lis._id}>
                        <li className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            ...
                            <img src={`${lis.symbolImage}`} className="w-6" alt="" />
                            <p className="leading-4 uppercase">{lis.name} <br /> <span className="text-sm text-neutral-400">{lis.symbol}</span></p>
                          </div>
                          <div className="">
                            <p>${lis.price}</p>
                            <p style={{ color: lis?.percentageChange < 0 ? 'red' : lis?.percentageChange > 0 ? 'green' : 'black' }} className="text-sm text-teal-700">
                              {typeof lis?.percentageChange === 'number' ? `${lis.percentageChange > 0 ? "+" : ''}${lis.percentageChange}%` : 'N/A'}
                            </p>
                          </div>
                        </li>
                      </a>
            ...
            <div className="lg:w-1/3 sm:w-1/2 w-full sl-px-2 sl-mb-4">
              <div className="border border-teal-900 rounded-3xl md:sl-px-4 sl-px-3 md:sl-py-6 sl-py-4">
                ...
                <ul className="md:space-y-4 space-y-2 md:mt-6 mt-4">
                  {
                    this.state.newCoins.slice(0, 5).map((lis) => (
                      <a href={lis.link} target="_blank" key={lis._id}>
                        <li className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            {/* <img src={`${filebaseUrl}/${lis.symbolImage}`} className="w-6" alt="" /> */}
            ...
            <div className="lg:w-1/3 sm:w-1/2 w-full sl-px-2 sl-mb-4">
              <div className="border border-teal-900 rounded-3xl md:sl-px-4 sl-px-3 md:sl-py-6 sl-py-4">
                ...
                <ul className="md:space-y-4 space-y-2 md:mt-6 mt-4">
                  ...
                  {
                    this.state.topGainers.slice(0, 5).map((lis) => (
                      <a href={lis.link} target="_blank" key={lis._id}>
                        <li className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            {/* <img src={`${filebaseUrl}/${lis.symbolImage}`} className="w-6" alt="" /> */}
